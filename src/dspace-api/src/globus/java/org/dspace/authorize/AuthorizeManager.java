...
public class AuthorizeManager
{
    ...
    {
        /*
        logger.info("Authorize on " + (o != null ? o.getName() : "null")
                + " for user " + (e != null ? e.getName() : "null")
                + " for action " + Constants.actionText[action]);
                */
...
//                    logger.info("*** Auth user authorized");
                        ...
                        && (Group.isMember(c, rp.getGroupID())))
                {
                    ...
                    // of that group
//                    logger.info("*** Auth user is a member of group " + Group.find(c, rp.getGroupID()).getName());
                    return true;
                }
            }
        }
