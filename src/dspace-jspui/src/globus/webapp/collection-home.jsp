...
<%--TODO - IF WE WANT TO CHANGE THIS TITLE TO SAY 'Publication' UPDATE THE TITLE HERE --%>
...
<% 	} %>
  ...
  <p class="copyrightText"><%= sidebar %></p>
    ...
    { %>
      <div>
          <form class="form-group" action="<%= request.getContextPath() %>/submit" method="post">
			...
			<input class="btn btn-success" type="submit" name="submit" value="<fmt:message key="jsp.collection-home.submit.button"/>" />
          </form>
     </div>
<%  } %>
