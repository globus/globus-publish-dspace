...
<%
    ...
    // Additional information specific to this installation
    String siteSpecificInfo = NewsManager.readNewsFile(LocaleSupport.getLocalizedMessage(pageContext, "home-site-specific.html"));
...
<!--
 ...
 -->
        ...
        <div class="col-md-3">
             <img class="pull-right" src="<%= request.getContextPath() %>/image/logo_globus_data_publication.png">
        </div>
</div>
