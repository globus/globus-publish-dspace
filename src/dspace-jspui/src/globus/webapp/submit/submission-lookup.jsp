...
<c:set var="dspace.layout.head.last" scope="request">
	<script type="text/javascript" src="<%= request.getContextPath() %>/static/js/globus-submission-lookup.js"></script>
</c:set>

<dspace:layout style="submission"
               titlekey="jsp.submit.start-lookup-submission.title"
               nocache="true">
               <%--locbar="off" navbar="off"  --%>
	...
	<form action="<%=request.getContextPath()%>/submit" method="post"
		...
		<div class="row">
			<div class="col-md-6 pull-right btn-group">
				<input class="btn btn-default col-md-4" type="submit"
					...
					value="<fmt:message key="jsp.submit.general.previous"/>" /> <input
					...
					<form class="form-horizontal" id="manual-form-submission1" action="" method="post">
						<input type="hidden" id="iuuid" name="iuuid" value=""/>
						<input type="hidden" id="fuuid" name="fuuid" value=""/>
						<input type="hidden" id="suuid" name="suuid" value="<%= uuid %>"/>
						<%=SubmissionController.getSubmissionParameters(context, request)%>
					...
					name="<%=AbstractProcessingStep.NEXT_BUTTON%>"
		...
		<div class="row">
			<div class="col-md-4 pull-right btn-group">
				<input class="btn btn-default col-md-6" type="submit"
					name="<%=AbstractProcessingStep.CANCEL_BUTTON%>"
					value="<fmt:message key="jsp.submit.general.cancel-or-save.button"/>" />
					<form class="form-horizontal" id="manual-form-submission" action="" method="post">
						<input type="hidden" id="iuuid" name="iuuid" value=""/>
						<input type="hidden" id="fuuid" name="fuuid" value=""/>
						<input type="hidden" id="suuid" name="suuid" value="<%= uuid %>"/>
						<%=SubmissionController.getSubmissionParameters(context, request)%>
	...
	<script type="text/javascript"><!--
    	...
    	j('#manual-submission-button').click(function(event){
    		...
    		//	j('#collectionid').val(colman);
    			j('#manual-form-submission').submit();
    		//}
    		//else
   			//{
