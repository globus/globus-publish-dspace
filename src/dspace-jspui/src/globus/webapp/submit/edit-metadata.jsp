            ...
            else if (isSelect)
            {
                ...
                for (int i = 0; i < cs.values.length; ++i)
                {
                    ...
                    sb.append("<option value=\"")
                      ...
                      .append(GlobusUIUtil.getLocalizedValue(pageContext, cs.values[i].label)).append("</option>\n");
                }
                sb.append("</select>\n");
            }
...
//          .append(">" + LocaleSupport.getLocalizedMessage(pageContext, "jsp.submit.edit-metadata.no_month") + "</option>");
            .append(">")
         ...
         for (int j = 1; j < 13; j++)
         {
            sb.append("<option value=\"")
              ...
              .append(">")
              .append(org.dspace.content.DCDate.getMonthName(j,I18nUtil.getSupportedLocale(pageContext.getResponse().getLocale())))
              .append("</option>");
         }
      ...
      for (int j = 0; j < fieldCount; j++)
      {
         ...
         for (int i = 0; i < qualMap.size(); i+=2)
         {
           ...
           sb.append("<option")
             ...
             .append(v)
             .append("\">")
             .append(GlobusUIUtil.getLocalizedValue(pageContext, q))
             .append("</option>");
         }
      ...
      throws java.io.IOException
    {
      ...
      for (int i = 0; i < valueList.size(); i += 2)
      {
         ...
         sb.append("<option ")
           ...
           .append("\">")
           .append(GlobusUIUtil.getLocalizedValue(pageContext, display))
           .append("</option>");
      }
...
<%
     ...
     for (int z = 0; z < inputs.length; z++)
     {
       ...
       if ((si.getMissingFields() != null) && (si.getMissingFields().contains(fieldName)))
       {
           if(inputs[z].getWarning() != null)
           {
                   ...
                   String req = "<div class=\"alert alert-warning\">" +
                                                        GlobusUIUtil.getLocalizedValue(pageContext, inputs[z].getWarning()) +
       ...
       else
       {
           ...
           if(inputs[z].getHints() != null)
           {
                    ...
                    <div class="help-block">
                        <%= GlobusUIUtil.getLocalizedValue(pageContext, inputs[z].getHints()) %>
                <%
       ...
       String label = GlobusUIUtil.getLocalizedValue(pageContext, inputs[z].getLabel());
