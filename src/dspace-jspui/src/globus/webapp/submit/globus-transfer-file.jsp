...
<%
    ...
    String endpoint = Globus.getSharedEndpointFullNameEncoded(""+itemId) + "/";
...
<%
	...
	jQuery(document).ready(function($){
		...
		//	window.location.replace("https://www.globus.org/xfer/SelectFile?resume=<%= resumeId %>&globus=true&action=http://localhost:8080/jspui/submit");
			window.open("https://www.globus.org/xfer/StartTransfer?dest=<%= endpoint %>");
		});
