...
<%@ taglib uri="http://www.dspace.org/dspace-tags.tld" prefix="dspace" %>
 ...
 $(document).ready(function() {
          $('.community-expand').click(function() {
            ...
            $(this).parent().parent().children(".media-list").toggle();
          });
   });
</script>
<%
...
<%!
    		...
    		Map collectionMap, Map subcommunityMap) throws ItemCountException, IOException, SQLException
    {
        ...
        out.println( "<div class=\"media-body\">" +
        	...
        	"<span style=\"color: #0066CC;cursor: pointer;\" class=\"community-expand glyphicon glyphicon-collapse-down\"></span> " +
        ...
        {
            out.println("<ul style=\"display: none;\" class=\"media-list\">");
