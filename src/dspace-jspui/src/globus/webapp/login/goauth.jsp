...
%>
     <h4><fmt:message key="jsp.goauth.description"/></h4>
     <p align="center" style="margin-top:75px;">

        <a href="<%= Globus.getGoAuthRedirectUrl(request)%>" style="margin-left: 400px;" class="btn btn-primary col-md-3"><fmt:message key="jsp.goauth.get.started"/></a>
    </p>
</dspace:layout>
