...
// check if the previous page had the advanced options expanded
Boolean advanced_search = (Boolean)request.getAttribute("advanced_search");
boolean advancedSearch = (advanced_search == null ? false : advanced_search.booleanValue());
...
<c:set var="dspace.layout.head.last" scope="request">
  <script type="text/javascript">
   ...
   jQ(document).ready(function() {
     ...
     jQ(".globus-search-expand").click(function(){
       if (jQ(this).children(".glyphicon").hasClass("glyphicon-collapse-down")){
	 jQ(this).children(".glyphicon").removeClass("glyphicon-collapse-down");
	 jQ(this).children(".glyphicon").addClass("glyphicon-collapse-up");
       } else {
	 jQ(this).children(".glyphicon").removeClass("glyphicon-collapse-up");
         jQ(this).children(".glyphicon").addClass("glyphicon-collapse-down");
       }
       jQ(this).parent().children(".search_results_div").toggle();
     });

     jQ("#advancedSearchLink").click(function(){
       jQ("#advancedSearchForm").toggle();
     });
     jQ("#advancedSearchClose").click(function(){
       jQ("#advancedSearchForm").hide();
     });
...
<dspace:layout titlekey="jsp.search.title">
  ...
  <% } else { %>
    <div class="discovery-search-form panel panel-default" id="advancedSearchForm" style="display:none;">
  <% }%>
  ...
  <div class="discovery-query panel-heading">
    <form action="simple-search" method="get">
      ...
      <button type="button" class="close pull-right" id="advancedSearchClose"><span aria-hidden="true">&times;</span></button>
      <label for="tlocation">
...
%><input type="submit" class="btn btn-default" name="submit_export_metadata" value="<fmt:message key="jsp.general.metadataexport.button"/>" /><%
    ...
    <div class="discovery-result-pagination row container">
      ...
      %>
      <%--Uncomment this if we want page links displayed above --%>
