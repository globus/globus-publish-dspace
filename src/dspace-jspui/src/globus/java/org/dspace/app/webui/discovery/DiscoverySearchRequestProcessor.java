...
public class DiscoverySearchRequestProcessor implements SearchRequestProcessor
{
            ...
            IOException, ServletException
    {
        ...
        try
        {
            ...
            // check if the advanced search area was open
            String advancedSearch = request.getParameter("advanced_search");
            boolean advancedS = false;
            if (advancedSearch != null && advancedSearch.equals("true")){
            	advancedS = true;
            }
            ...
            request.setAttribute("advanced_search", new Boolean(advancedS));
