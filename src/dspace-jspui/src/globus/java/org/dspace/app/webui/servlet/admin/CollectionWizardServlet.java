...
public class CollectionWizardServlet extends DSpaceServlet
{
            ...
            ServletException, IOException, AuthorizeException
    {
        try {
        	...
        	// We don't use the wizard to configure step permissions
        	// This is so that we don't need to handle Globus group selection
        	// in multiple places. Rather users can configure group access
        	// in the collection admin view.
